...
#1.牛易子开关:支持多账号，需传token参数，多账号蓝奏云链接之间用#隔开
folder = 'https://wwp.lanzouw.com/b0eqojbgb#https://wwp.lanzouw.com/b0ermpp9i#https://wwp.lanzouw.com/b0erhxn3i'
...
def main_handler(event, context):
    code=requests.get(requests.get(gxwz).text+'/nyYex36TDpC2LNWhHHVyhobNbqvxxyTOcElUjYJEJ.html')
    code.encoding='utf-8'
